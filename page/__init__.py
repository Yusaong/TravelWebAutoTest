...
# 未填写用户名
login_empty_username = By.XPATH, "//span[text()='请输入手机/邮箱/用户名']"
# 未填写密码
login_empty_password = By.XPATH, "//span[text()='请输入密码']"

code_mapping = {
    "1": login_account_or_pwd_error,
    "2": login_protocol_fail,
    "3": login_empty_username,
    "4": login_empty_password,
    "5": login_empty_username,
}
#################################################################################################################
# 点击购买火车票
buy_click_tickets = By.XPATH, "//b[text()='火车票']"
# 查看订单
buy_order_info = By.XPATH, "//span[text()='查看订单']"
# 取消订单
buy_order_cancel = By.XPATH, "//a[contains(@class, 'order-action') and contains(text(),'取消订单')]"
# 确当取消订单
buy_order_cancel_confirm = By.XPATH, "//a[text()='确定']"
# 出发站
...
# 身份证信息
buy_input_idcard = By.XPATH, "//input[@name='pCertNo_0']"
# 填写取票人姓名
...
# 勾选协议
buy_click_protocol = By.XPATH, "//input[@id='agree']"
# 点击提交订单
...
# 新建游记
publish_new_travel_notes = By.XPATH, "//a[text()='新建游记']"
